/**
 * Catch-all route for /otp/rent/property/*
 *
 ...
 * serves the property/index.html for any URL under /otp/rent/property/, and
 * the front-end JS reads the slug from window.location.pathname.
 *
 * Examples this catches:
 *   /otp/rent/property/test-2-br-lawson-heights
 *   /otp/rent/property/test-2-br-lawson-heights/
 *   /otp/rent/property/anything
 *   /otp/rent/property/  (passes through to the natural index.html)
 */
...
export async function onRequest(context) {
  ...
  const indexUrl = new URL('/otp/rent/property/index.html', url.origin);
